...
public class MarkdownProcessor {
     ...
     */
    public static String mcToMarkdown(String text) {

        if (!text.matches(".*[&" + ChatColor.COLOR_CHAR + "][0-9A-Fa-fk-oK-OrR].*")) {
            return text;
        }
    ...
    /**
     * Conversion from adventure components to Markdown
     *
    ...
    /**
     * Conversion from markdown to adventure component
     *
     * @param markdown the markdown string
     * @return created component
     */
    public static Component toComponent(String markdown) {
        return LegacyComponentSerializer.legacySection().deserialize(markdownToMC(markdown));
    }
